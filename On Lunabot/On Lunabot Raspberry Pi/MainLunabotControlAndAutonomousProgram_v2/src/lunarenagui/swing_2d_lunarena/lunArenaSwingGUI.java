...
public class lunArenaSwingGUI extends javax.swing.JFrame implements autonomousSystemListener {
    ...
    private LinkedList nextArenaObstacleGrid;
    private LinkedList robotPath;
    private LinkedList nextRobotPath;
    ...
    private void initCustomComponents(){
        ...
        this.nextArenaObstacleGrid = new LinkedList();
        this.nextRobotPath = new LinkedList();
    ...
    private void drawPath(Graphics g){
        ...
        this.robotPath.addAll(this.nextRobotPath);
    ...
    private void drawObstacleFieldGrid(Graphics g){
        ...
        this.arenaObstacleGrid.addAll(this.nextArenaObstacleGrid);
    }
    ...
    public void updateDataFromAutonomousSystem(short lunabotPositionInCentimeters_X, 
        ...
        if (this.nextArenaObstacleGrid == null){
            this.nextArenaObstacleGrid = new LinkedList();
        }
        ...
        if (checkObj != null){
            ...
            if (checkArray[0] < 0){
                ...
                this.nextArenaObstacleGrid.clear();
                this.nextArenaObstacleGrid.addAll(arenaObstacleGrid);
            } else {
                this.nextArenaObstacleGrid.addAll(arenaObstacleGrid);
            }
        }
        
        if (this.nextRobotPath == null){
            this.nextRobotPath = new LinkedList();
        }
        
        // reset the planned robot path
        this.nextRobotPath.clear();
        this.nextRobotPath.addAll(RobotPath);
