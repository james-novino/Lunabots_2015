...
public class LED_BeaconMasterController implements Runnable, beaconACKListener {
    ...
    private final int NUM_COMPASS_AVERAGES_FOR_BIAS = 300;
    
    private long [] firstCompassReadings;
    
    private int numCompassReadings = 0;
    
    private long gyroBias = 0;
    ...
    private float xPositionOfScannersInArenaInCentimeters = -48.26f;
    ...
    public LED_BeaconMasterController(String serverIP, int UDPPort, boolean displayParticleGUIs, String initialHeading){
        ...
        this.firstCompassReadings = new long[this.NUM_COMPASS_AVERAGES_FOR_BIAS];
    ...
    private void setHeadingOffsetInRadians(){
        ...
        else if (this.initialHeading.equals("N") 
        ...
        else if (this.initialHeading.equals("W") 
        ...
        else if (this.initialHeading.equals("S") 
    ...
    private void setAverageGyroOutputWhenStopped(){
        long ave = 0;
        for (int i = 0; i<this.NUM_COMPASS_AVERAGES_FOR_BIAS; i++){
            ave += this.firstCompassReadings[i];
        }
        ave /= this.NUM_COMPASS_AVERAGES_FOR_BIAS;
        this.gyroBias = ave;
    }
